...
var SqlMqWorker, async, clearWithdrawal, config, getWithdrawal, getWithdrawalAddress, loopAndProcessWithdrawal, request, sendDogecoins;
...
sendDogecoins = function(options, callback) {
  ...
  return request.post(url).auth("admin", config.get("dogecoinExpressApiKey")).send({}).end(function(error, response) {
